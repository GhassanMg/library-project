    ...
    <form class="card card-md" action="{{ route('login') }}" method="post" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" class="form-control @error('phone') is-invalid @enderror" placeholder="{{ __('Enter email Or Phone Number') }}" required autofocus tabindex="1">
                @error('phone')
